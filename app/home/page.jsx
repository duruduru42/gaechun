                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mb-5">
                    <div className="p-3 md:p-4 flex flex-col gap-3 bg-white rounded-xl grow cursor-pointer hover:shadow-md">
                        <div>
                            ...
                            <div className="text-lg font-bold text-neutral-800">{koreanRank +1}/{totalUsers + 8}</div>
                        </div>
                    </div>
                    ...
                    <div className="p-3 md:p-4 flex flex-col gap-3 bg-white rounded-xl grow cursor-pointer hover:shadow-md">
                        <div>
                            ...
                            <div className="text-xs mb-1 text-neutral-600">내 등수 / 전체 인원</div>
                            <div className="text-lg font-bold text-neutral-800">{mathRank }/{totalUsers+ 8}</div>
                        </div>
                    </div>
                    ...
                    <div className="p-3 md:p-4 flex flex-col gap-3 bg-white rounded-xl grow cursor-pointer hover:shadow-md">
                        <div>
                            ...
                            <div className="text-xs mb-1 text-neutral-600">내 등수 / 전체 인원</div>
                            <div className="text-lg font-bold text-neutral-800">{scienceRank}/{totalUsers+ 8}</div>
                        </div>
                    </div>
                    ...
                    <div className="p-3 md:p-4 flex flex-col gap-3 bg-white rounded-xl grow cursor-pointer hover:shadow-md">
                        <div>
                            ...
                            <div className="text-xs mb-1 text-neutral-600">내 등수 / 전체 인원</div>
                            <div className="text-lg font-bold text-neutral-800">{totalRank}/{totalUsers+ 8}</div>
                        </div>
                    </div>
                </div>
