        ...
        try {
            ...
            const { error } = await supabase
                ...
                .update({
                    ...
                    grade_korean: parseInt(gradeKorean),
                    grade_math: parseInt(gradeMath),
                    grade_english: parseInt(gradeEnglish),
                    grade_history: parseInt(gradeHistory),
                    grade_science1: parseInt(gradeScience1),
                    grade_science2: parseInt(gradeScience2),
        ...
        <div className="text-left box-border p-4 border-4 flex flex-col items-center justify-center">
            ...
            {isTakingForeignLanguage && (
                <>
                    ...
                    {renderInputField('standard_score_foreignLanguage', '표준점수 입력', standardScoreForeignLanguage, setStandardScoreForeignLanguage, 'percentile_foreignLanguage')}
                    {renderInputField('percentile_foreignLanguage', '백분위 입력', percentileForeignLanguage, setPercentileForeignLanguage, 'grade_foreignLanguage')}
