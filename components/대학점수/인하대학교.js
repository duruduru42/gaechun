...
// Conversion tables for English and Korean History scores
const getEnglishScore = (grade, track) => {
    const englishScores = track === '자연' ? {
        1: 100, 2: 98, 3: 96, 4: 90, 5: 80,
        6: 60, 7: 40, 8: 20, 9: 0
    } : {
        1: 150, 2: 148, 3: 145, 4: 135, 5: 120,
        6: 100, 7: 80, 8: 40, 9: 0
    };
...
// Conversion table for exploration scores
...
export const 인하대학교 = async (userId, selection) => {
    ...
    const totalExplorationScore = (convertedScienceScore1 + convertedScienceScore2) / (68.83 * 2);
    // Calculate total score based on track
    ...
    return (totalScore * 1000).toFixed(2);
};
