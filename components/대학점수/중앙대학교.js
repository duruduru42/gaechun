...
export const 중앙대학교 = async (userId, selection) => {
  ...
  if (
    selection.계열 === '인문' &&
    (humanitiesSubjects.includes(science1) || humanitiesSubjects.includes(science2))
  ) {
    baseScore *= 1.05; 
  }
  ...
  if (
    selection.계열 === '자연' &&
    (naturalScienceSubjects.includes(science1) || naturalScienceSubjects.includes(science2))
  ) {
    baseScore *= 1.05; 
  }
